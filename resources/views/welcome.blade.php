    ...
    <div class="body-wrapper">
        ...
        <div class="ltn__slider-area ltn__slider-3 ltn__slider-6 section-bg-1">
            <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white---">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 align-self-center">
                                        ...
                                        <div class="slide-item-info-inner ltn__slide-animation">
                                            <div class="slide-item-info">
                                                <div class="slide-item-info-inner ltn__slide-animation">
                                                    ...
                                                    <h6
                                                        class="slide-sub-title ltn__body-color slide-title-line animated">
                                    ...
                                    <img src="{{ asset('assets/frontend/img') }}/slider/41-1.png" alt="#">
                ...
                <!-- ltn__slide-item  -->
                <div class="ltn__slide-item ltn__slide-item-8 text-color-white---- bg-image bg-overlay-theme-black-80---"
                    data-bs-bg="{{ asset('assets/frontend/img') }}/slider/3.jpg">
                    <div class="ltn__slide-item-inner">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 align-self-center">
                        ...
                        <div
                            ...
                            <div class="ltn__feature-item ltn__feature-item-8">
                                <div class="ltn__feature-icon">
                                    <img src="{{ asset('assets/frontend/img') }}/icons/svg/8-trolley.svg"
                                        alt="#">
                                </div>
                            ...
                            <div class="ltn__feature-item ltn__feature-item-8">
                                <div class="ltn__feature-icon">
                                    <img src="{{ asset('assets/frontend/img') }}/icons/svg/9-money.svg"
                                        alt="#">
                                </div>
                                <div class="ltn__feature-info">
                            ...
                            <div class="ltn__feature-item ltn__feature-item-8">
                                <div class="ltn__feature-icon">
                                    <img src="{{ asset('assets/frontend/img') }}/icons/svg/10-credit-card.svg"
                                        alt="#">
                                </div>
                                <div class="ltn__feature-info">
                            ...
                            <div class="ltn__feature-item ltn__feature-item-8">
                                <div class="ltn__feature-icon">
                                    <img src="{{ asset('assets/frontend/img') }}/icons/svg/11-gift-card.svg"
                                        alt="#">
                                </div>
                                <div class="ltn__feature-info">
                ...
                <div class="row justify-content-center">
                        ...
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/1.png" alt="#"></a>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/2.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/3.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/4.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="badge-1">Hot</li>
                                    </ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/5.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="badge-1">Hot</li>
                                    </ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/6.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/7.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
                                        <li class="badge-1">Hot</li>
                                    </ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        <div class="ltn__product-item text-center">
                            <div class="product-img">
                                <a href="product-details.html"><img
                                        src="{{ asset('assets/frontend/img') }}/product/8.png" alt="#"></a>
                                <div class="product-badge">
                                    <ul>
            ...
            <div class="container">
                ...
                <div class="row  ltn__blog-slider-one-active slick-arrow-1">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/frontend/img') }}/blog/1.jpg"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                ...
                                <h3 class="ltn__blog-title blog-title-line"><a href="blog-details.html">Lorem ipsum
                                        dolor sit amet con adipisicing elit sed </a></h3>
                            </div>
                        </div>
                    </div>
                    <!-- Blog Item -->
                    <div class="col-lg-12">
                        <div class="ltn__blog-item">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/frontend/img') }}/blog/2.jpg"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/frontend/img') }}/blog/3.jpg"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/frontend/img') }}/blog/4.jpg"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
                    ...
                    <div class="col-lg-12">
                        <div class="ltn__blog-item">
                            <div class="ltn__blog-img">
                                <a href="blog-details.html"><img src="{{ asset('assets/frontend/img') }}/blog/5.jpg"
                                        alt="#"></a>
                            </div>
                            <div class="ltn__blog-brief">
                                <div class="ltn__blog-meta">
