<div class="tab-pane fade show active" id="addCar" role="tabpanel" aria-labelledby="addCar">
            ...
            <div class="col-lg-12">
                ...
                <div class="card mt-25 mb-40">
                    <div class="card-header text-capitalize px-md-25 px-3">
                        <h6>List Car</h6>
                        <div class="dropdown">
                            <a href="#" role="button" id="products" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <span data-feather="more-horizontal"></span>
                            </a>
                        </div>
