                                ...
                                <div class="pt-0 outline-0 pb-0 pr-0 pl-0 rounded-0 position-relative d-flex align-items-center"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center w-100">
                                        <div
                                            ...
                                            <input class="form-control border-0 p-0 bg-transparent pr-sm-0 pr-20"
                            ...
                            <div class="mb-3 ap-post-gallery">
                                ...
                                <div class="ap-post-gallery-top">
                                    <div class="ap-post-gallery__item">
                                        <a href="img/506.png"><img src="img/506.png" alt="gallery"
                                                class="w-100 img-fluid"></a>
                                    </div>
                                    <div class="ap-post-gallery__item">
                                        <a href="img/907.png"><img src="img/907.png" alt="gallery"
                                                class="w-100 img-fluid"></a>
                                    </div>
                                </div>
                                <!-- Post Gallery top -->
                                ...
                                <div class="ap-post-gallery-bottom">
                                    <div class="ap-post-gallery__item">
                                        <a href="img/brightland_3744.png"><img src="img/brightland_3744.png"
                                                alt="gallery" class="w-100 img-fluid"></a>
                                    </div>
                                    <div class="ap-post-gallery__item">
                                        <a href="img/room.png"><img src="img/room.png" alt="gallery"
                                                class="w-100 img-fluid"></a>
                                    </div>
                                    <div class="ap-post-gallery__item">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="ffw d-flex justify-content-between">
                                ...
                                <div class="ffw__button">
                                    ...
                                    <button class="btn btn-default btn-squared btn-outline-light friends-follow"><span
                            ...
                            <a class="view-more-comment color-primary fs-13 fw-500 px-25 pb-20" href="#">Load
                                more friends</a>
                        </div>
                    </div>
                </div>
