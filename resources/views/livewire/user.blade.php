                ...
                <div class="breadcrumb-main add-contact justify-content-sm-between ">
                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                        ...
                        <div class="action-btn mt-sm-0 mt-15">
                            <a href="{{ route('user.create') }}" class="btn px-20 btn-primary ">
                    ...
                    <div class="breadcrumb-main__wrapper">
                        ...
                        <form action="/" class="d-flex align-items-center add-contact__form my-sm-0 my-2">
                            ...
                            <input wire:model="search" class="form-control mr-sm-2 border-0 box-shadow-none"
                                user="search" placeholder="Search by Name" aria-label="Search">
                        </form>
                                        ...
                                        @foreach ($query as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="userDatatable-content d-inline-block">
                                                        <span
                                                            class="bg-opacity-{{ $row->is_active == 1 ? 'success' : 'danger' }}  color-{{ $row->is_active == 1 ? 'success' : 'danger' }} rounded-pill userDatatable-content-status active">{{ $row->is_active == 1 ? 'Active' : 'Inactive' }}</span>
                                                    </div>
                                                </td>
                                                <td>
